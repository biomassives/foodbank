...
export const demoContacts: Address[] = [
  ...
  },
  {
    ...
    email: 'jake.t@wardvolunteer.org',
    phone: '(303) 555-0102',
  },
  {
    id: 'demo-contact-3',
    name: { first: 'Aisha', last: 'Patel' },
    email: 'aisha.p@wardvolunteer.org',
    phone: '(303) 555-0103',
  },
  {
    id: 'demo-contact-4',
    name: { first: 'Ben', last: 'Wright' },
    email: 'ben.w@wardfoodpantry.org',
    phone: '(303) 555-0104',
  },
  {
    id: 'demo-contact-5',
    name: { first: 'Rosa', last: 'Martinez' },
    email: 'rosa.m@wardvolunteer.org',
    phone: '(303) 555-0105',
  },
  {
    id: 'demo-contact-6',
    name: { first: 'Devon', last: 'Park' },
    email: 'devon.p@wardvolunteer.org',
    phone: '(303) 555-0106',
  },
  {
    id: 'demo-contact-7',
    name: { first: 'Sam', last: 'Okafor' },
    email: 'sam.o@wardfoodpantry.org',
    phone: '(303) 555-0107',
  },
];
...
export const demoQueueEntries: Entry[] = [
  // PENDING (orange) — waiting for a driver
  {
    ...
    location: 'East Ward Community Hub',
    status: 'active',
    queueStatus: 'pending',
    createdAt: ago(1.5),
    syncedToCloud: false,
  ...
  // CLAIMED (yellow) — driver accepted, hasn't left yet
  {
    ...
    location: 'Ward Parish Food Pantry',
    status: 'active',
    queueStatus: 'claimed',
  ...
  },
  {
    ...
    location: 'South Ward Mobile Stop',
    status: 'active',
    queueStatus: 'in_transit',
...
export const demoCommunityEntries: Entry[] = [
  ...
  },
  {
    id: 'demo-entry-6',
    type: 'looking_for',
    description: 'Need one more driver for Friday East Ward run. 2-hour shift, large vehicle preferred.',
    status: 'active',
    createdAt: ago(24),
    syncedToCloud: false,
  },
  {
    id: 'demo-entry-7',
    type: 'upcoming_need',
    description: 'Thanksgiving meal kits for 45 ward families — need donations and packing volunteers by Nov 20.',
    status: 'active',
    createdAt: ago(72),
    syncedToCloud: false,
  },
...
export const demoLocalStorage: Record<string, string> = {
  ...
  'pantry-ops-page': JSON.stringify({
    ...
    intro:
      ...
      'Serving East Ward, the Veterans Annex, South Ward, and the school district.',
    sections: [
      {
        id: 'hours',
        title: 'Hours & Pickup Locations',
        body:
          'Mon/Wed/Fri — East Ward Community Hub · 9am–1pm\n' +
      ...
      },
      {
        ...
        title: 'Who We Serve',
        body:
          'Any household in the ward is welcome. No ID required, no income verification, no appointments. ' +
