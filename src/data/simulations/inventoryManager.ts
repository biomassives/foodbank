...
export const inventoryManager: Simulation = {
  ...
  name: 'Maple Street Pantry — Inventory Manager',
  subtitle: 'Admin view: offered inventory lifecycle from donation to shelf',
  description:
    'Six locations, seven people, and a morning\'s worth of incoming donations. ' +
  ...
  contacts: [
    // Admin/manager
    { id: 'inv-c1', name: { first: 'Patricia', last: 'Kim' },     email: 'pat@maplestpantry.org',    phone: '(415) 555-0201' },
    // Community donors
    ...
    // Stock volunteers
    { id: 'inv-c4', name: { first: 'Wei',      last: 'Zhang' },   email: 'wei.z@volunteers.org',    phone: '(415) 555-0204' },
    { id: 'inv-c5', name: { first: 'Amanda',   last: 'Osei' },    email: 'amanda.o@helpers.net',    phone: '(415) 555-0205' },
    // Driver
    { id: 'inv-c6', name: { first: 'Robert',   last: 'Finch' },   email: 'r.finch@drivers.org',     phone: '(415) 555-0206' },
    // Community member (submits needs)
    { id: 'inv-c7', name: { first: 'Layla',    last: 'Hassan' },  email: 'layla.h@community.net',   phone: '(415) 555-0207' },
  ],

  locations: [
    {
      id: 'inv-loc-1', name: 'Maple Street Warehouse',
    ...
    {
      id: 'inv-loc-2', name: 'Community Drop-off Center',
    ...
    {
      id: 'inv-loc-3', name: 'Riverside Farmers Market',
      schedule: ['SAT'],
    ...
    {
      id: 'inv-loc-4', name: "St. Anne's Church Hall",
      schedule: ['TUE', 'THU'],
    ...
    {
      id: 'inv-loc-5', name: 'Hillside Food Co-op',
      schedule: ['WED', 'FRI'],
    ...
    {
      id: 'inv-loc-6', name: 'Parkview Senior Center',
      schedule: ['MON', 'THU'],
  ...
  entries: [
    ...
    },
    {
      ...
      description: 'Hillside Co-op: brown rice 50 lb × 4, red lentils 25 lb × 6, quinoa 10 lb × 3. Near-expiry — best used within 3 months.',
    ...
    },
    {
      ...
      description: 'Corporate donation: hygiene kits × 40 (soap, shampoo, deodorant, toothbrush, paste). Palletised at our Brannan St office.',
      status: 'active', createdAt: ago(12), syncedToCloud: false,
    },
    {
      id: 'inv-offer-6', type: 'offering',
      description: 'Farmers market surplus — assorted stone fruit (apricots, plums, peaches), approx 50 lbs total. Perishable — collect same day.',
    ...
    },
    {
      ...
      description: 'Hygiene kits for 8 individuals at transitional housing. Any format accepted.',
    ...
    // ── PICKUP QUEUE — accepted offerings in motion ───────────────────
    {
      ...
      description: 'Hygiene kits × 40 — accepted corporate donation from Brannan St. Palletised.',
      location: 'Maple Street Warehouse',
    ...
    // ── UPCOMING NEEDS — planning ahead ──────────────────────────────
    {
      ...
      description: 'Thanksgiving box prep — need 60 turkey donations + stuffing kits by Nov 18. Coordinating with 3 churches.',
      status: 'active', calendarDate: future(14),
      createdAt: ago(72), syncedToCloud: false,
    },
    {
      id: 'inv-upcoming-2', type: 'upcoming_need',
      description: 'Winter coat drive launch — need 40+ coats (adult M–XL, children 6–12) for December distribution.',
    ...
    // ── LOOKING FOR ────────────────────────────────────────────────────
    {
      ...
      description: 'Seeking a refrigerated van for Saturday farmers market runs — 4 hours, weekly. Know anyone?',
  ...
  localStorageContent: {
    'pantry-welcome': JSON.stringify({
      name: 'Maple Street Community Pantry',
      tagline: 'Good food for every neighbour',
      about:
        'A community-managed pantry operating across six locations in the Maple Street district. ' +
    ...
    'pantry-ops-page': JSON.stringify({
      pageTitle: 'Maple Street Community Pantry',
      intro: 'Accepting donations Monday–Saturday across six sites. Sorting and distribution happens daily from our Maple St Warehouse.',
      sections: [
        {
          id: 'donate',
          title: 'How to Donate',
          body: 'Drop non-perishables at the Community Drop-off Center (Mon/Wed/Fri, 10am–2pm).\n' +
                'Fresh produce: contact us to arrange a pickup or bring to our Saturday farmers market slot.\n' +
                'Bulk or palletised items: email pat@maplestpantry.org to schedule a dock appointment.',
        },
        {
          id: 'hours',
          title: 'Distribution Hours',
          body: 'Maple Street Warehouse — Mon–Fri 9am–4pm\n' +
                'Community Drop-off — Mon/Wed/Fri 10am–2pm\n' +
                'St. Anne\'s Church Hall — Tue/Thu 10am–1pm\n' +
                'Parkview Senior Center — Mon/Thu 11am–2pm',
        },
        {
          id: 'needed',
    ...
    'pantry-weekly-schedule': JSON.stringify({
      1: { open: true, openTime: '09:00', closeTime: '16:00', notes: 'Warehouse + Drop-off + Parkview' },
      2: { open: true, openTime: '10:00', closeTime: '14:00', notes: "St. Anne's + Warehouse" },
      3: { open: true, openTime: '09:00', closeTime: '16:00', notes: 'Warehouse + Drop-off + Hillside Co-op' },
      4: { open: true, openTime: '10:00', closeTime: '15:00', notes: "St. Anne's + Warehouse + Parkview" },
      5: { open: true, openTime: '09:00', closeTime: '15:00', notes: 'Warehouse + Drop-off + Hillside Co-op' },
      6: { open: true, openTime: '10:00', closeTime: '13:00', notes: 'Farmers Market (surplus pickup)' },
    ...
    'pantry-staged-messages': JSON.stringify([
      {
        ...
        body: 'David Rosario (Valley Farm) has submitted a produce donation — butternut squash (60 lbs), kale (30 bunches), sweet corn (4 dozen ears). Available Saturday morning. Please confirm a pickup driver by Friday 3pm.',
        roles: ['drivers', 'logistics_outreach'],
        createdAt: ago(18),
      },
      {
        id: 'inv-msg-2',
        subject: '✅ Inventory update: Bulk grains accepted from Hillside Co-op',
        body: 'The Hillside Co-op bulk grain donation has been accepted and queued for pickup. Robert Finch has claimed the run. Expected arrival at Maple St Warehouse by 2pm today.',
        roles: ['stock_pantry', 'admin'],
        createdAt: ago(0.5),
      },
      {
        id: 'inv-msg-3',
        subject: '📊 Weekly inventory overview — Maple Street Pantry',
