<template>
  <div class="queue-wrap">
    ...
    <div class="queue-filter-bar">
      <div class="queue-filter-toggle">
        <button class="filter-tab" :class="{ 'filter-tab--active': filterMode === 'all' }" @click="filterMode = 'all'">ALL</button>
        <button class="filter-tab" :class="{ 'filter-tab--active': filterMode === 'mine' }" @click="filterMode = 'mine'">MY TASKS</button>
      </div>
    </div>
