...
Deno.serve(async (req) => {
  ...
  try {
    ...
    for (const org of orgs || []) {
      ...
      // 4. Batch emails into the parallel queue
      ...
      // 5. Async update of the timestamp (non-blocking)
      emailPromises.push(
    ...
    // 6. Wait for EVERYTHING (Mail and DB updates) to finish
...
<body style="font-family: 'Nunito', sans-serif; background: #000; color: #fff; padding: 24px;">
  <div style="max-width: 500px; margin: 0 auto;">
    ...
    <p style="color: rgba(255,255,255,0.4); font-size: 10px; letter-spacing: 1px;">
      Ward Food Pantry &mdash; Funky Pony
    </p>
  </div>
</body>
</html>`;
