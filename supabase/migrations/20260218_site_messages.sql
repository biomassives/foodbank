...
BEGIN
  ...
  VALUES
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000000', 'admin@funkypony.space', extensions.crypt('password123', extensions.gen_salt('bf')), now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{"name":"Pantry Admin"}', now(), now()),
    ('11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000000', 'agent@funkypony.space', extensions.crypt('password123', extensions.gen_salt('bf')), now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{"name":"Field Scout"}', now(), now());
EXCEPTION WHEN unique_violation THEN
  NULL; -- users already exist, skip
END $$;
...
VALUES 
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000001', 'admin@funkypony.space', 'admin'),
  ('11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'agent@funkypony.space', 'member')
ON CONFLICT (id) DO NOTHING;
...
BEGIN
  ...
  VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin@funkypony.space', extensions.crypt('password123', extensions.gen_salt('bf')), now(), 'authenticated', 'authenticated');
EXCEPTION WHEN unique_violation THEN
  NULL;
END $$;
...
VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin@funkypony.space', 'admin')
ON CONFLICT (id) DO NOTHING;
